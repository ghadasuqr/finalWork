...
<!-- ----------------------------------------------------------- -->
@if(count($cartIds)==0)
<div  class="text-right"><h5 class="sectionTitle  " >لا يوجد منتجات فى  المشتريات </h5></div>  
@else
<!-- ----------------------------------------------------------- -->
            ...
            <table class="table table-responsive box-shadow " style="padding:40px 120px">
                        ...
                        <!-- data= favorite table  foe certain  authorized user  -->
                            ...
                            <tr class="border-top">
                                <td colspan="5"></td>
                                @if($item->isReturned ==1)    
                                <td  colspan="2" >  الاجمالى  بعد الارجاع  </td>
                                @endif
                                ...
                                <td  colspan="2" class="text-left  box-shadow  border-top-bottom px-3" >{{App\Cart::  TotalForOrder($cartIds)  }} <span class="price  font-color">ج</span></td>
                            </tr>
                                            ...
                                            <td>
                                                <div class="basic_detail">
                                                    <div>
                                                            ...
                                                            <h5> {{$userInfo->receiverName}}</h5>
                                                        </div>
                                                        <div>
                                                            <span>  تليفون المستلم </span> 
                                                            <h5>{{$userInfo->receiverPhone}}</h5>
                                                         </div>
                                                </div>
                                                <!-- basic_detail -->
                                            </td>

        ...
        <div class="row">
             ...
             <div class="col-md-12 col-sm-12">
                 <div class="shopping-cart-header main-bg text-center">
                   <h3 class="text-center">    الطلبات  المكتملة  المدفوعة  </h3>
                                    ...
                                    <!-- <div class="table-responsive"> -->
                                          ...
                                          <tr>
                                            ...
                                            <tr class="main-bg">
                                                ...
                                                <th class="title"  scope="col" width="500">اسم الموظف </th>
                                                ...
                                                <th class="title"  scope="col" width="70"> تفاصيل  </th>
                                                <th class="title"  scope="col" width="70"> فاتورة  </th>
                                                <th class="title"  scope="col" width="70"> حذف  </th>
                                            ...
                                            @foreach($data as $key=>$order)
                                                ...
                                                <td>{{$key+1}}</td>
                                                  <td>{{$order->orderNo}}</td>
                                                    ...
                                                    <td class="text-right"> 
                                                    <a href="{{url('dashboard/orders/invoice/'.$order->orderNo)}}" class="btn btn-outline-warning px-1"><i class="fa fa-vcard"></i> فاتورة</a>
                                                    </td>

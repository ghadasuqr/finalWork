                                          ...
                                          <tr>
                                              <td colspan="6">
                                                <div class="login">
                                                  ...
                                                  <input  class="form-control mb-2" type="text" name="q" placeholder="البحث باسم المستخدم او الميل     او الرقم "  value="@if(isset($_GET['q'])){{$_GET['q']}}@endif"> 
                                                  {!! Form::Close() !!}
                                                </div>
                                              </td>
                                            ...
                                            <tr class="main-bg">
                                                ...
                                                <th class="title"  scope="col" width="200"> حجب</th>
                                            ...
                                            <tr @if($user->Role == 1) class="backg-not-active" @endif >
                                                ...
                                                <td>{{$user->id}}</td>
                                                  <td >{{ $user->name }}</td>
                                                    ...
                                                    <td class="text-right"> 
                                                    <button class="btn btn-outline-danger" @if($user->Role == 1)  style="display:none" @endif> × حجب</button>
                                                    </td>
                                                    {!! Form::Close()!!}

                                        ...
                                        <div class="shopping-cart-table" > 
                                            <!-- <div class="table-responsive"> -->
                                                        ...
                                                        <div class="login">
                                                                ...
                                                                <input  class="form-control mb-2" type="text" name="q" placeholder="البحث  باسم المنتج او نوع القماش  او  كود المنتج "  value="@if(isset($_GET['q'])){{$_GET['q']}}@endif"> 
                                                                {!! Form::Close() !!}
                                                            </div>
                                                        </td></tr>
                                                        <!--  -->
                                                   ...
                                                   <tr @if($item->active == 1) class="backg-not-active" @endif>
                                                                    ...
                                                                    <td>  رقم ( {{ $key +1}} ) <br><br>
                                                                        ...
                                                                        <br> <br>
                                                                        <span class="font-color border px-4 py-2">  كود  ( {{ $item->code  }}  )  </span>
                                                                            ...
                                                                            <h5 class="infoTitle"> {{ $color->color }} </h5>                                                                                   
                                                                                <ul >
                                                                                    <!-- //size -->                                                                                
                                                                                        ...
                                                                                        <li><span class="size">{{ $size->size}}</span><br><span class="count"  style="@if($size->count <= 0)  background:red  ; padding:0 7px @endif"  >{{  $size->count}}</span></li>
                                                                                        @endforeach
                                                                                    <!-- //size -->
                                                                                </ul>
                                                                         @endforeach   
                                                                    ...
                                                                    <td>
                                                                        <div class="design_detail">
                                                                            ...
                                                                            <div class="info-content">
                                                                                <div class="type">سلايدر   </div>
                                                                                <div class="t-value  @if ($item->slider =="نعم" )main-bg @endif " >{{ $item->slider }} </div>
                                                                            </div>
                                                            ...
                                                            <tr style="border-bottom:2px solid #aaa">
                                                                ...
                                                                <a  href="{{ url('dashboard/items/edit/'.$item->code) }}" ><button class="btn btn-outline-warning px-5 mt-4"> تعديل </button></a>
                                                                    {!! Form::Open(['url' => 'dashboard/items/destroy/'.$item->code  ]) !!}                                                             
                                                                      <button  class="btn btn-outline-danger px-5 " > × اخفاء</button>
                                                                    {!! Form::Close()   !!}
